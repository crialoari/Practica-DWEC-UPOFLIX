...
function crearCuenta(){
    ...
    if(!bValido){
        ...
        /*HACE FALTA BOOLEAN*/
        alert(oUpoflix.altaUsuario(oUsuario));
        //solo si fue bien
...
function iniciarSesion(){
    ...
    if(!bValido){
        ...
        /*HACE FALTA BOOLEAN*/
        alert(oUpoflix.iniciarSesion(sUsuario,sContraseña));
        //solo si fue bien
        inicio();
    }
}
